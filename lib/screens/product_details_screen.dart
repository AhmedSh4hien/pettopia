...
class ProductDetailsScreen extends StatelessWidget {
  ...
  ProductDetailsScreen(this.selectedProd);
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Name : " + selectedProd.name.toString()),
                          Text("Description : " +
                              selectedProd.description.toString()),
                          Text("Price : " + selectedProd.price.toString()),
                          Text(
                              "Location : " + selectedProd.location.toString()),
                        ],
                      ),
                    ),
                  ),
